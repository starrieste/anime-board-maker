...
- custom background image for board
...
### way later
- templates
- circle boards, star boards, custom boards?
- connections lines?
- shareable link maybe encoding
- "fill all" button to clear all or to fill with random characters/anime
